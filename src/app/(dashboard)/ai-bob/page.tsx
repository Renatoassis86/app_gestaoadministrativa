...
export default function AlmaPage() {
  return (
    <WipPage
      ...
      subtitle="Assistente de Leitura e Missão Analítica da Cidade Viva Education"
      tag="Em Breve"
      headline="ALMA: a inteligência que conhece cada escola tanto quanto você"
      description="ALMA é a IA comercial da CVE Education. Ela analisa o histórico completo de cada parceiro, sugere o próximo passo estratégico, identifica leads negligenciados e gera insights para acelerar o fechamento de contratos — tudo com base nos dados reais da sua operação."
      features={[
