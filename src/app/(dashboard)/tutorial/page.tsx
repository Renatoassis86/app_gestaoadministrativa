  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      <PageHeader
        ...
        subtitle="Guia completo de todos os módulos do CVE Gestão Comercial"
      />
      ...
      <div style={{ padding: '2rem 2.5rem' }}>
        ...
        <div style={{
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <p style={{ fontSize: '.875rem', color: 'rgba(255,255,255,.55)', fontFamily: 'var(--font-inter,sans-serif)', lineHeight: 1.7, maxWidth: 520 }}>
              Esta plataforma centraliza toda a gestão comercial da Cidade Viva Education.
        ...
        <div style={{ background: 'linear-gradient(135deg, #0f172a, #1e293b)', borderRadius: 16, padding: '2rem', textAlign: 'center', marginTop: '1rem' }}>
          ...
          <div style={{ display: 'flex', gap: '.75rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            <a href="https://wa.me/5511973916735" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '.4rem', padding: '.55rem 1.25rem', borderRadius: 9999, background: '#16a34a', color: '#fff', textDecoration: 'none', fontSize: '.78rem', fontWeight: 700, fontFamily: 'var(--font-montserrat,sans-serif)' }}>
              ...
              WhatsApp (11) 97391-6735
            </a>
            <a href="mailto:comercial.education@cidadeviva.org" style={{ display: 'inline-flex', alignItems: 'center', gap: '.4rem', padding: '.55rem 1.25rem', borderRadius: 9999, border: '1px solid rgba(255,255,255,.2)', background: 'rgba(255,255,255,.06)', color: '#fff', textDecoration: 'none', fontSize: '.78rem', fontWeight: 600, fontFamily: 'var(--font-montserrat,sans-serif)' }}>
              ...
              comercial.education@cidadeviva.org
            </a>
          </div>
        </div>
