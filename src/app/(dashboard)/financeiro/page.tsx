  ...
  return (
    <div className="p-6">
      <div className="wip-banner">
        ...
        <h2 style={{ fontSize: '1.5rem', fontWeight: 800, marginTop: '1rem', marginBottom: '.5rem' }}>Financeiro</h2>
        <p style={{ color: 'rgba(255,255,255,.75)', fontSize: '.95rem' }}>Controle de caixa e conciliações.</p>
