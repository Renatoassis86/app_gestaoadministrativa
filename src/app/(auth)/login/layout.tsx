...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Gestão administrativa inteligente e integrada',
    description: 'Ferramenta exclusiva para a equipe interna da Cidade Viva Education.',
    images: [{ url: '/images/hero-modulos.png', width: 1672, height: 941, alt: 'Cidade Viva Education — Gestão Administrativa' }],
    type: 'website',
  },
  twitter: {
