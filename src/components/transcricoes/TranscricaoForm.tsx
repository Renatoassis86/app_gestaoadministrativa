            ...
            <form onSubmit={handleSubmit} style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1.1rem' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                <div>
                  ...
                  <input value={titulo} onChange={e => setTitulo(e.target.value)} placeholder="Ex: Apresentação Currículo Paideia" style={inp} />
                </div>
                <div>
              ...
              <div>
                ...
                <input value={participantes} onChange={e => setParticipantes(e.target.value)}
                  placeholder="Ex: João Silva (diretor), Maria Costa (coordenadora), Renato Assis (CVE)"
                  style={inp} />
              </div>
