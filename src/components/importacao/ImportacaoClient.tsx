...
interface Resultado { inseridos: number; erros: number; total: number }
    ...
    <div style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box' }}>
      ...
      {etapa === 'resultado' && resultado && (
        <div style={{ textAlign: 'center', padding: '3rem 1rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '1rem', maxWidth: 480, margin: '0 auto 2rem' }}>
            {[
