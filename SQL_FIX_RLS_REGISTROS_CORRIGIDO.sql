-- ============================================================
-- FIX CORRIGIDO: RLS POLICIES PARA REGISTROS
-- ============================================================
-- Problema: Política "registros_select_auth" já existe
-- Solução: Remover TODAS as políticas (antigas E novas) antes de criar
-- ============================================================
...
-- 2. REMOVER POLÍTICAS NOVAS SE EXISTIREM (para evitar conflito)
